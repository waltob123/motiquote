...
class Profile(Base, BaseModel):
    ...
    gender_id = Column(String(255), ForeignKey('genders.id'), nullable=False, unique=True)
    country_id = Column(String(255), ForeignKey('countries.id'), nullable=False, unique=True)
